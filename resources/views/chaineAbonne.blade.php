                    ...
                    <div class="vignette-vid-info-recom">
                        ...
                        <div class="resume-vigne-stat">
                            ...
                            <div class="bull-name-stat">
                                ...
                                <div class="d-flex justify-content-between blockPlayist" >
                                    <p class="numberviewsSuggestion"> </p>
                                    <a href="{{route('playlist.add', $playlist->id)}}" data-toggle="tooltip" data-placement="top" title="Add to my playlist"><img src="{{ asset('img/report-gris.svg') }}"  alt="Add to my playlist"></a>
                                </div>
                                @endif
                            </div>
                        </div>
