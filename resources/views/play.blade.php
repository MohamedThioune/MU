                    ...
                    <div class="sousBlockTitle">
                        ...
                        <div class="blockLikeEval">
                            ...
                            <div class="evalution">
                                ...
                                <p class="appreciationTilte">Appréciations</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row ">
            <div class="col-md-5  col-lg-5 col-sm-12">
                <div class="commentOne commentBlock">
                    ...
                    <form method="POST" class="formCommentairePlay" action="/comments">
                        @csrf
...
<div class="MobElementIn">
            ...
            <div class="container-fluid">
                <div class="contentSwipeToday">
                    <div class="barreLatraleNoir vertBarre">
                        <div class="categorie-name">
                            <img src="{{ asset('img/nature.png') }}"  alt="">
                        </div>
                    </div>
    ...
    <script>
        ...
        function start(){
            if(video_play.readyState > video_play.HAVE_METADATA && barometer.value == "" ){
                blessings.style.display = "block";
                barometer.value = "1";
                setTimeout(toggle, 5000);
                var duration = video_play.duration;
                wait = (duration - 5)*1000;
                setTimeout(end, wait);
                setTimeout(endof, 5000);
            }
        }
